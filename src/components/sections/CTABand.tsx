...
export default function CTABand() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center px-8 py-24" style={{ background: 'linear-gradient(180deg, #FFFFFF 0%, #FFFFFF 20%, #F0FCF5 45%, #E5F8FA 65%, #D8ECFB 82%, #D0DAFA 100%)', minHeight: '400px' }}>
