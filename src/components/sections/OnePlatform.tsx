    ...
    <section className="py-24 px-8 md:px-16 bg-gradient-to-br from-[#EDF3F1] to-[#DDEEE4]">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <button className="bg-emerald-rich hover:bg-emerald-deep text-white px-6 py-3.5 rounded-lg font-bold text-sm transition-colors cursor-pointer">{t('cta')} →</button>
        </div>
