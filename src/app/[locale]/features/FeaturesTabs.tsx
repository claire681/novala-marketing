  ...
  return (
    <div>
        ...
        <div className="flex gap-1 min-w-max">
          {features.map((feature, i) => (
            <button
              ...
              className={`px-6 py-4 text-base font-semibold whitespace-nowrap transition-all border-b-2 -mb-px cursor-pointer ${activeTab === i ? 'text-emerald-bright border-emerald-bright' : 'text-white border-transparent hover:text-white'}`}
            >
              {feature.title}
            </button>
          ))}
      ...
      <div>
        ...
        <p className="text-base md:text-lg text-white leading-relaxed mb-8">{current.description}</p>
