      ...
      <main className="pt-32 pb-16 bg-white min-h-screen">
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          <div className="text-center mb-12 max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-black text-near-black mb-6 leading-tight">{content.title}</h1>
            <p className="text-lg md:text-xl text-[#5A6970] leading-relaxed">{content.subtitle}</p>
          </div>
          <FeaturesTabs features={content.features} />
          <div className="bg-emerald-deep text-white rounded-3xl p-12 text-center mt-16">
            <h2 className="text-3xl md:text-4xl font-black mb-4">{content.ctaHeading}</h2>
            <p className="text-lg text-white/80 mb-8">{content.ctaSubheading}</p>
